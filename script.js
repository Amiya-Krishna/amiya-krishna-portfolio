...
const projectData = [
  {
    ...
    gallery: [
      {
        src: "assets/projects/tracker-dashboard.jpg",
        alt: "Job application dashboard",
      },
      {
        src: "assets/projects/tracker-add-jobs.jpg",
        alt: "API tested with Postman",
      },
      {
        src: "assets/projects/tracker-email-integration.jpg",
        alt: "Secure login screen",
      },
      {
        src: "assets/projects/tracker-analytics.jpg",
        alt: "Secure login screen",
      },
      {
        src: "assets/projects/tracker-job-discovery.jpg",
        alt: "Secure login screen",
      },
      {
        src: "assets/projects/tracker-matched-job.jpg",
        alt: "Secure login screen",
      },
    ],
  ...
  {
    title: "Collexa — College Decision Intelligence Platform",
    isLive: true,
...

  {
    ...
    gallery: [
      {
        src: "assets/projects/forum-dashboard.jpg",
        alt: "Discussion feed dashboard",
      },
      {
        src: "assets/projects/forum-create-discussion.jpg",
        alt: "Create discussion thread",
      },
      {
        src: "assets/projects/forum-comments.jpg",
        alt: "Live comments & replies",
      },
    ],
...
function openModal(i) {
  ...
  statusEl.className =
    "modal-status " + (p.isLive ? "status-live" : "status-progress");
  ...
  if (p.architecture && p.architecture.length) {
    archEl.innerHTML = p.architecture
      .map((item) => `<li>${item}</li>`)
      .join("");
