...
| **College Discovery Platform** | Search, filter, compare and get an AI-assisted, rank-based college recommendation. Live in production. | Next.js 16 · TypeScript · Prisma · PostgreSQL · Zod | [Live](https://college-discovery-vert.vercel.app) · [Code](https://github.com/Amiya-Krishna/college-discovery) |
